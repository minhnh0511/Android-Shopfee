...
public interface AboutUsConfig {
    String ABOUT_US_TITLE = "Shopfee";
    String ABOUT_US_CONTENT = "Shopfee - Bring you good drinks, developed by minhnhhe170924 " +
    ...
    String ABOUT_US_WEBSITE_TITLE = "FPT/PRM392/minhnhhe170924";
